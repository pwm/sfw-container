...
class DAGTest extends TestCase
{
    ...
    public function scenario_2(): void
    {
        ...
        $c->add(A2C1::class, function () { return new A2C1($this->resolve(A2C2::class)); });
    ...
    public function scenario_3(): void
    {
        ...
        $c->add(A3C1::class, function () { return new A3C1($this->resolve(A3C2::class)); });
        $c->add(A3C2::class, function () { return new A3C2($this->resolve(A3C3::class)); });
    ...
    public function scenario_4(): void
    {
        ...
        $c->add(A4C1::class, function () { return new A4C1($this->resolve(A4C2::class), $this->resolve(A4C3::class)); });
    ...
    public function scenario_5(): void
    {
        ...
        $c->add(A5C1::class, function () { return new A5C1($this->resolve(A5C2::class), $this->resolve(A5C3::class)); });
        $c->add(A5C2::class, function () { return new A5C2($this->resolve(A5C3::class)); });
    ...
    public function scenario_6(): void
    {
        ...
        $c->add(A6C1::class, function () { return new A6C1($this->resolve(A6C2::class), $this->resolve(A6C3::class)); });
        $c->add(A6C2::class, function () { return new A6C2($this->resolve(A6C4::class)); });
        $c->add(A6C3::class, function () { return new A6C3($this->resolve(A6C4::class)); });
    ...
    public function scenario_7(): void
    {
        ...
        $c->add(A7C1::class, function () { return new A7C1($this->resolve(A7C2::class), $this->resolve(A7C3::class)); });
        $c->add(A7C2::class, function () { return new A7C2($this->resolve(A7C3::class), $this->resolve(A7C4::class)); });
        $c->add(A7C3::class, function () { return new A7C3($this->resolve(A7C4::class)); });
